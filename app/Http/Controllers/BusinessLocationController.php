...
class BusinessLocationController extends Controller
{
    public function index()
    {
        ...
        $businessLocations = BusinessLocation::with('business')->paginate(10);
    ...
    public function create()
    {
        ...
        return view('business_locations.create', compact('businesses'));
    }
    ...
    public function edit(BusinessLocation $businessLocation)
    {
        // $tenants = Tenant::all();
        $businesses = Business::all();
        return view('business_locations.edit', compact('businessLocation', 'businesses'));
    }
