...
@section('content')
    <div class="container mx-auto p-6">
        <h1 class="text-2xl font-bold mb-4">Create Inventory Adjustment</h1>
        @if (session('success'))
        ...
        <form action="{{ route('inventory_summaries.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="reason" class="mt-1 block w-full border rounded p-2" placeholder="e.g., Stock take, Damage">
