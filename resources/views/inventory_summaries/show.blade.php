...
@section('content')
    <div class="container mx-auto p-6">
        ...
        <div class="bg-white p-6 rounded shadow">
            ...
            <p><strong>Tenant:</strong> {{ $inventorySummary->tenant->name }}</p>
            <p><strong>Business:</strong> {{ $inventorySummary->business->name }}</p>
            <p><strong>Location:</strong> {{ $inventorySummary->location->name }}</p>
